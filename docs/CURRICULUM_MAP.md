...
**Status: reference.** This document exists so it's possible to see, at a glance, everything the app currently teaches (or plans to teach) — every unit, every lesson inside it, which verb/tense combination it drills, and **exactly what's new versus what's review** — without having to read `journey.js`/`lessons.js` directly.

It is a companion to `docs/LEARNING_JOURNEY.md`, which is the *design-rationale* document (why units are ordered/scoped the way they are). This document only answers "what is unit N, and what new conjugation does lesson X actually teach?"
...
- The indented line(s) below it say what's *new* about that specific lesson, using four tags:
  ...
  - ✅ **Taught this tense for the first time** — an already-known verb getting a conjugation table it didn't have before (e.g. `ikusi` already known in the present, now getting its past).
  - ➕ **Adds persons** — the same verb+tense table the learner already has, gaining grammatical persons it didn't cover yet (e.g. `ni/zu/hura` → `gu/zuek/haiek`).
...
- A pool/review wide enough that listing every verb by name would be unreadable collapses to `verb, verb, verb, +N more (total)`.
...
This is generated from live data (`src/journey.js` + `src/data/lessons.js` + `src/data/verbs.js`), walked in the exact order a learner encounters it, so the "new vs. review" verdict for each lesson is computed the same way a learner would experience it — not hand-transcribed. If you regenerate it, `src/journey.test.js` (run via `npm test`) is the check that every lesson id here is real and every real lesson id is listed somewhere.
...
## Units & lessons, in full — what's new in each one
...
- `izan-present` — izan ("to be") — Present [ni/zu/hura]
  - 🆕 **New grammar pattern:** Present — the first time this conjugation pattern appears (ni/zu/hura)
  - 📗 **New verb:** izan
...
- `izan-present-perfect-pool` — **Pooled practice** [ni/zu/hura]: izan (Present perfect), joan (Present perfect), etorri (Present perfect)
  - 🆕 **New grammar pattern:** Present perfect — the first time this conjugation pattern appears (ni/zu/hura)
...
- `izan-past-pool` — **Pooled practice** [ni/zu/hura]: 11 verbs pooled — Past
  - 🆕 **New grammar pattern:** Past — the first time this conjugation pattern appears (ni/zu/hura)
...
- `nor-nork-present-plural-pool` — **Pooled practice** [ni/zu/hura]: 18 verbs pooled — Present (plural)
  - 🆕 **New grammar pattern:** Present (plural) — the first time this conjugation pattern appears (ni/zu/hura)
...
- `nor-nori-present-pool` — **Review**: gustatu (Present), iruditu (Present), ahaztu (Present), jarraitu (Present), jario (Present), etorri (Present (NORI axis))
  - 🆕 **New grammar pattern:** Present (NORI axis) — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
...
- `nor-nork-past-plural-pool` — **Pooled practice** [ni/zu/hura]: 18 verbs pooled — Past (plural)
  - 🆕 **New grammar pattern:** Past (plural) — the first time this conjugation pattern appears (ni/zu/hura)
...
- `ukan-object-axis-present` — ukan ("to have") — Present (object axis) [hura/zu/zuek/haiek]
  - 🆕 **New grammar pattern:** Present (object axis) — the first time this conjugation pattern appears (hura/zu/zuek/haiek)
...
- `ukan-object-axis-past` — ukan ("to have") — Past (object axis) [hura/zu/zuek/haiek]
  - 🆕 **New grammar pattern:** Past (object axis) — the first time this conjugation pattern appears (hura/zu/zuek/haiek)
...
- `izan-future` — izan ("to be") — Future [ni/zu/hura]
  - 🆕 **New grammar pattern:** Future — the first time this conjugation pattern appears (ni/zu/hura)
...
- `nor-nork-future-plural-pool` — **Pooled practice** [ni/zu/hura]: 18 verbs pooled — Future (plural)
  - 🆕 **New grammar pattern:** Future (plural) — the first time this conjugation pattern appears (ni/zu/hura)
...
- `etorri-habitual-past` — etorri ("to come") — Past (habitual) [ni/zu/hura]
  - 🆕 **New grammar pattern:** Past (habitual) — the first time this conjugation pattern appears (ni/zu/hura)
...
- `motion-imperfective-past-pool` — **Review** [ni/zu/hura]: joan (Past (imperfective, motion)), etorri (Past (imperfective, motion)), ibili (Past (imperfective, motion))
  - 🆕 **New grammar pattern:** Past (imperfective, motion) — the first time this conjugation pattern appears (ni/zu/hura)
...
- `nor-nori-past-pool` — **Review**: gustatu (Past), iruditu (Past), ahaztu (Past), jarraitu (Past), jario (Past), etorri (Past (NORI axis))
  - 🆕 **New grammar pattern:** Past (NORI axis) — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
...
- `nor-axis-present-review-zu` — **Review** [ni/gu/zuek]: gustatu (Present (NOR axis)), iruditu (Present (NOR axis)), ahaztu (Present (NOR axis)), jarraitu (Present (NOR axis))
  - 🆕 **New grammar pattern:** Present (NOR axis) — the first time this conjugation pattern appears (ni/gu/zuek)
...
- `nor-axis-past-review-zu` — **Review** [ni/gu/zuek]: gustatu (Past (NOR axis)), iruditu (Past (NOR axis)), ahaztu (Past (NOR axis)), jarraitu (Past (NOR axis))
  - 🆕 **New grammar pattern:** Past (NOR axis) — the first time this conjugation pattern appears (ni/gu/zuek)
...
- `izan-potential` — izan ("to be") — Potential (Ahalera)
  - 🆕 **New grammar pattern:** Potential (Ahalera) — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
...
- `izan-potential-alegiazkoa` — izan ("to be") — Potential, hypothetical
  - 🆕 **New grammar pattern:** Potential, hypothetical — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
...
- `izan-potential-lehenaldia` — izan ("to be") — Potential, past
  - 🆕 **New grammar pattern:** Potential, past — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
...
- `izan-baldintza` — izan ("to be") — Conditional-if (Baldintza)
  - 🆕 **New grammar pattern:** Conditional-if (Baldintza) — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
  - ✅ **Taught this tense for the first time:** izan — Conditional-if (Baldintza)
- `izan-conditional` — izan ("to be") — Conditional-would (Ondorioa)
  - 🆕 **New grammar pattern:** Conditional-would (Ondorioa) — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
...
- `izan-conditional-past` — izan ("to be") — Conditional-would, past
  - 🆕 **New grammar pattern:** Conditional-would, past — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
...
- `izan-imperative` — izan ("to be") — Imperative (Agintera)
  - 🆕 **New grammar pattern:** Imperative (Agintera) — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
...
- `unit-30-plural-object-review` — **Review**: ukan (Imperative (Agintera)), ukan (Imperative (plural))
  - 🆕 **New grammar pattern:** Imperative (plural) — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
...
- `unit-30-ditransitive-review` — **Review**: esan (Imperative (ditransitive)), eman (Imperative (ditransitive))
  - 🆕 **New grammar pattern:** Imperative (ditransitive) — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
...
- `izan-subjunctive-present` — izan ("to be") — Subjunctive (present) [hura/haiek]
  - 🆕 **New grammar pattern:** Subjunctive (present) — the first time this conjugation pattern appears (hura/haiek)
...
- `izan-subjunctive-past` — izan ("to be") — Subjunctive (past) [hura/haiek]
  - 🆕 **New grammar pattern:** Subjunctive (past) — the first time this conjugation pattern appears (hura/haiek)
...
- `izan-present-toka` — izan ("to be") — Present (toka)
  - 🆕 **New grammar pattern:** Present (toka) — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
...
- `izan-past-toka` — izan ("to be") — Past (toka)
  - 🆕 **New grammar pattern:** Past (toka) — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
...
- `izan-present-noka` — izan ("to be") — Present (noka)
  - 🆕 **New grammar pattern:** Present (noka) — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
...
- `izan-past-noka` — izan ("to be") — Past (noka)
  - 🆕 **New grammar pattern:** Past (noka) — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
...
- `ukan-potential-object-axis-present` — ukan ("to have") — Potential (object axis) [hura/zu/zuek/haiek]
  - 🆕 **New grammar pattern:** Potential (object axis) — the first time this conjugation pattern appears (hura/zu/zuek/haiek)
...
- `ukan-potential-object-axis-alegiazkoa` — ukan ("to have") — Potential, hypothetical (object axis) [hura/zu/zuek/haiek]
  - 🆕 **New grammar pattern:** Potential, hypothetical (object axis) — the first time this conjugation pattern appears (hura/zu/zuek/haiek)
...
- `ukan-potential-object-axis-lehenaldia` — ukan ("to have") — Potential, past (object axis) [hura/zu/zuek/haiek]
  - 🆕 **New grammar pattern:** Potential, past (object axis) — the first time this conjugation pattern appears (hura/zu/zuek/haiek)
...
- `potential-axis-review-ni` — **Review** [zu/gu/zuek]: gustatu (Potential (NOR axis)), iruditu (Potential (NOR axis)), ahaztu (Potential (NOR axis)), jarraitu (Potential (NOR axis))
  - 🆕 **New grammar pattern:** Potential (NOR axis) — the first time this conjugation pattern appears (zu/gu/zuek)
...
- `potential-alegiazkoa-axis-review-ni` — **Review** [zu/gu/zuek]: gustatu (Potential, hypothetical (NOR axis)), iruditu (Potential, hypothetical (NOR axis)), ahaztu (Potential, hypothetical (NOR axis)), jarraitu (Potential, hypothetical (NOR axis))
  - 🆕 **New grammar pattern:** Potential, hypothetical (NOR axis) — the first time this conjugation pattern appears (zu/gu/zuek)
...
- `potential-lehenaldia-axis-review-ni` — **Review** [zu/gu/zuek]: gustatu (Potential, past (NOR axis)), iruditu (Potential, past (NOR axis)), ahaztu (Potential, past (NOR axis)), jarraitu (Potential, past (NOR axis))
  - 🆕 **New grammar pattern:** Potential, past (NOR axis) — the first time this conjugation pattern appears (zu/gu/zuek)
...
- `unit-34-ditransitive-review` — **Review**: 12 verbs pooled — Potential (Ahalera)
  - 🆕 **New grammar pattern:** Potential (plural) — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
  - 🆕 **New grammar pattern:** Potential, past (plural) — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
  - 🆕 **New grammar pattern:** Potential, hypothetical (plural) — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
...
- `ukan-baldintza-object-axis` — ukan ("to have") — Conditional-if (object axis) [hura/zu/zuek/haiek]
  - 🆕 **New grammar pattern:** Conditional-if (object axis) — the first time this conjugation pattern appears (hura/zu/zuek/haiek)
...
- `ukan-conditional-object-axis` — ukan ("to have") — Conditional-would (object axis) [hura/zu/zuek/haiek]
  - 🆕 **New grammar pattern:** Conditional-would (object axis) — the first time this conjugation pattern appears (hura/zu/zuek/haiek)
...
- `ukan-conditional-past-object-axis` — ukan ("to have") — Conditional-would, past (object axis) [hura/zu/zuek/haiek]
  - 🆕 **New grammar pattern:** Conditional-would, past (object axis) — the first time this conjugation pattern appears (hura/zu/zuek/haiek)
...
- `baldintza-axis-review-ni` — **Review** [zu/gu/zuek]: gustatu (Conditional-if (NOR axis)), iruditu (Conditional-if (NOR axis)), ahaztu (Conditional-if (NOR axis)), jarraitu (Conditional-if (NOR axis))
  - 🆕 **New grammar pattern:** Conditional-if (NOR axis) — the first time this conjugation pattern appears (zu/gu/zuek)
...
- `conditional-axis-review-ni` — **Review** [zu/gu/zuek]: gustatu (Conditional-would (NOR axis)), iruditu (Conditional-would (NOR axis)), ahaztu (Conditional-would (NOR axis)), jarraitu (Conditional-would (NOR axis))
  - 🆕 **New grammar pattern:** Conditional-would (NOR axis) — the first time this conjugation pattern appears (zu/gu/zuek)
...
- `conditional-past-axis-review-ni` — **Review** [zu/gu/zuek]: gustatu (Conditional-would, past (NOR axis)), iruditu (Conditional-would, past (NOR axis)), ahaztu (Conditional-would, past (NOR axis)), jarraitu (Conditional-would, past (NOR axis))
  - 🆕 **New grammar pattern:** Conditional-would, past (NOR axis) — the first time this conjugation pattern appears (zu/gu/zuek)
...
- `unit-35-ditransitive-review` — **Review**: 12 verbs pooled — Conditional-if (Baldintza)
  - 🆕 **New grammar pattern:** Conditional-if (plural) — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
  - 🆕 **New grammar pattern:** Conditional-would (plural) — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
  - 🆕 **New grammar pattern:** Conditional-would, past (plural) — the first time this conjugation pattern appears (ni/zu/hura/gu/zuek/haiek)
...
- `gustatu-imperative-axis` — gustatu ("to like / please") — Imperative (NOR axis) [hura/zuek/haiek]
  - 🆕 **New grammar pattern:** Imperative (NOR axis) — the first time this conjugation pattern appears (hura/zuek/haiek)
