...
export const LESSONS = [
  ...
  // #306 — the `egin`/`hartu`/`eman`/`egon`/`jarri` fixed noun+verb
  // expressions (see the matching `VERBS` block above). Appended here,
  // after Unit 43, rather than inserted at its "natural" spot earlier in
  // the curriculum — lesson unlocking is driven by this array's order, not
