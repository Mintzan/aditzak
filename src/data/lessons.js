...
export const LESSONS = [
  ...
  // synthetic-paradigm introducers (#309), not fodder.
  {
    ...
    sources: [
      ...
      { verbId: 'mugitu-izan', tense: 'present' },
      { verbId: 'babestu-izan', tense: 'present' },
    ],
  },
  {
  ...
  // remaining regular-`nor` fodder, from #319/#320) into this canonical pool.
  {
    ...
    sources: [
      ...
      { verbId: 'mugitu-izan', tense: 'past' },
      { verbId: 'babestu-izan', tense: 'past' },
    ],
  },
  {
  ...
  // appear only in the singular pool; the plural pool simply drops them.
  {
    ...
    sources: [
      ...
      { verbId: 'mugitu-izan', tense: 'future' },
      { verbId: 'babestu-izan', tense: 'future' },
    ],
  },
  {
  ...
  // #358/#359/#419/#441: gustatu/iruditu/ahaztu's presentByNor/pastByNor
  // NOR-NORI object-axis lessons originally shipped as 36 single-verb
  // lessons (3 verbs x 2 tenses x 6 NORI values), then #441 added the pooled
  // cross-verb reviews below without removing them, so the unit grew to 48.
  // #469 collapsed it the same way #445/#446 already collapsed the
  // baldintza/ondorioa and ahalera axes: removed the 36 single-verb
  // lessons, kept just the 12 pooled reviews (one per tense per NORI value),
  // which already mix in `jarraitu` as the 4th verb and cover everything
  // the single-verb lessons drilled.
  {
  ...
  // #445: gustatu/iruditu/ahaztu's Baldintza/Ondorioa NOR-NORI object-axis
  // lessons (#425) had no pooled cross-verb review, unlike Unit 27's
  // presentByNor/pastByNor axis (#441) and Unit 35's imperativeByNor axis
  // (#444) — 54 single-verb recognition-only lessons (3 verbs x 3 moods x 6
  // NORI values) sat in a row instead. Collapsed here into 18 pooled
  // reviews (one per mood per NORI value), mixing in `jarraitu` as the 4th
  // member (its baldintzaByNor/conditionalByNor/conditionalPastByNor tables
  // added in `data/verbs.js` alongside this change — hand-written, matching
  // its existing presentByNor/pastByNor/imperativeByNor tables, since
  // #436's runtime composer only covers the NOR-NORK `byObject` axis today,
  // not `byNor` — extending it there is still #448's tracked follow-up).
  // `jario` stays excluded (thing-NOR, #442). `mode: 'recognition'`
  // preserved from the lessons this replaces. `persons` mirrors each NORI
  // value's own reflexive-gap NOR list, same as #441/#444's reviews.
  {
    id: 'baldintza-axis-review-ni',
    review: true,
    mode: 'recognition',
    persons: ['zu', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'ni' },
    sources: [
      { verbId: 'gustatu', tense: 'baldintzaByNor' },
      { verbId: 'iruditu', tense: 'baldintzaByNor' },
      { verbId: 'ahaztu', tense: 'baldintzaByNor' },
      { verbId: 'jarraitu', tense: 'baldintzaByNor' },
    ],
  },
  {
    id: 'baldintza-axis-review-zu',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'zu' },
  ...
  {
    id: 'baldintza-axis-review-haiek',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'zu', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'haiek' },
  ...
  {
    id: 'conditional-axis-review-ni',
    review: true,
    mode: 'recognition',
    persons: ['zu', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'ni' },
    sources: [
      { verbId: 'gustatu', tense: 'conditionalByNor' },
      { verbId: 'iruditu', tense: 'conditionalByNor' },
      { verbId: 'ahaztu', tense: 'conditionalByNor' },
      { verbId: 'jarraitu', tense: 'conditionalByNor' },
    ],
  },
  {
    id: 'conditional-axis-review-zu',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'zu' },
  ...
  {
    id: 'conditional-axis-review-hura',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'zu', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'hura' },
  ...
  {
    id: 'conditional-axis-review-zuek',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'zu', 'gu'],
    objectAxis: { vary: 'nor', fixed: 'zuek' },
  ...
  {
    id: 'conditional-axis-review-haiek',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'zu', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'haiek' },
  ...
  {
    id: 'conditional-past-axis-review-ni',
    review: true,
    mode: 'recognition',
    persons: ['zu', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'ni' },
    sources: [
      { verbId: 'gustatu', tense: 'conditionalPastByNor' },
      { verbId: 'iruditu', tense: 'conditionalPastByNor' },
      { verbId: 'ahaztu', tense: 'conditionalPastByNor' },
      { verbId: 'jarraitu', tense: 'conditionalPastByNor' },
    ],
  },
  {
    id: 'conditional-past-axis-review-zu',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'zu' },
  ...
  {
    id: 'conditional-past-axis-review-hura',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'zu', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'hura' },
  ...
  {
    id: 'conditional-past-axis-review-gu',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'zu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'gu' },
  ...
  {
    id: 'conditional-past-axis-review-zuek',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'zu', 'gu'],
    objectAxis: { vary: 'nor', fixed: 'zuek' },
  ...
  {
    id: 'conditional-past-axis-review-haiek',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'zu', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'haiek' },
  ...
  // #446: gustatu/iruditu/ahaztu's Ahalera NOR-NORI object-axis lessons
  // (#425) had no pooled cross-verb review, same gap #441/#444/#445 already
  // fixed for the other psych-axis moods — 54 single-verb recognition-only
  // lessons (3 verbs x 3 potential sub-tenses x 6 NORI values) sat in a row
  // instead. Collapsed here into 18 pooled reviews (one per sub-tense per
  // NORI value), mixing in `jarraitu` as the 4th member (its potentialByNor/
  // potentialAlegiazkoaByNor/potentialLehenaldiaByNor tables added in
  // `data/verbs.js` alongside this change — hand-written, same #436/#448
  // composer-scope reasoning as #445's entry). `jario` stays excluded
  // (thing-NOR, #442). `mode: 'recognition'` preserved from the lessons
  // this replaces. `persons` mirrors each NORI value's own reflexive-gap
  // NOR list, same as #441/#444/#445's reviews.
  {
    id: 'potential-axis-review-ni',
    review: true,
    mode: 'recognition',
    persons: ['zu', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'ni' },
    sources: [
      { verbId: 'gustatu', tense: 'potentialByNor' },
      { verbId: 'iruditu', tense: 'potentialByNor' },
      { verbId: 'ahaztu', tense: 'potentialByNor' },
      { verbId: 'jarraitu', tense: 'potentialByNor' },
    ],
  },
  {
    id: 'potential-axis-review-zu',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'zu' },
  ...
  {
    id: 'potential-axis-review-haiek',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'zu', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'haiek' },
  ...
  {
    id: 'potential-alegiazkoa-axis-review-ni',
    review: true,
    mode: 'recognition',
    persons: ['zu', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'ni' },
    sources: [
      { verbId: 'gustatu', tense: 'potentialAlegiazkoaByNor' },
      { verbId: 'iruditu', tense: 'potentialAlegiazkoaByNor' },
      { verbId: 'ahaztu', tense: 'potentialAlegiazkoaByNor' },
      { verbId: 'jarraitu', tense: 'potentialAlegiazkoaByNor' },
    ],
  },
  {
    id: 'potential-alegiazkoa-axis-review-zu',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'zu' },
  ...
  {
    id: 'potential-alegiazkoa-axis-review-hura',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'zu', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'hura' },
  ...
  {
    id: 'potential-alegiazkoa-axis-review-gu',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'zu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'gu' },
  ...
  {
    id: 'potential-alegiazkoa-axis-review-zuek',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'zu', 'gu'],
    objectAxis: { vary: 'nor', fixed: 'zuek' },
  ...
  {
    id: 'potential-alegiazkoa-axis-review-haiek',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'zu', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'haiek' },
  ...
  {
    id: 'potential-lehenaldia-axis-review-ni',
    review: true,
    mode: 'recognition',
    persons: ['zu', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'ni' },
    sources: [
      { verbId: 'gustatu', tense: 'potentialLehenaldiaByNor' },
      { verbId: 'iruditu', tense: 'potentialLehenaldiaByNor' },
      { verbId: 'ahaztu', tense: 'potentialLehenaldiaByNor' },
      { verbId: 'jarraitu', tense: 'potentialLehenaldiaByNor' },
    ],
  },
  {
    id: 'potential-lehenaldia-axis-review-zu',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'zu' },
  ...
  {
    id: 'potential-lehenaldia-axis-review-hura',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'zu', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'hura' },
  ...
  {
    id: 'potential-lehenaldia-axis-review-gu',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'zu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'gu' },
  ...
  {
    id: 'potential-lehenaldia-axis-review-zuek',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'zu', 'gu'],
    objectAxis: { vary: 'nor', fixed: 'zuek' },
  ...
  {
    id: 'potential-lehenaldia-axis-review-haiek',
    review: true,
    mode: 'recognition',
    persons: ['ni', 'zu', 'gu', 'zuek'],
    objectAxis: { vary: 'nor', fixed: 'haiek' },
