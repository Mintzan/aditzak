...
describe('generateQuestions', () => {
  ...
  describe('extraCandidates filtering by a sentence\'s validFor (docs/academic/SENTENCE_FRAMES.md)', () => {
...
// (docs/academic/SENTENCE_FRAMES.md), shared by generateCrossVerbQuestions and
...
// `validFor` decision (docs/academic/SENTENCE_FRAMES.md) — even `validFor: []` counts
...
describe('validFor coverage for the nor-nork cluster (docs/academic/SENTENCE_FRAMES.md, #124/#315)', () => {
