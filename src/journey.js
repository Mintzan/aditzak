...
// expansion checkpoints (Units 10, 22, 29, 41 — the present-perfect
// insertion at Unit 11 first shifted Gates B/C/D up by one from the
// `LEARNING_JOURNEY_PROPOSED.md` N-20/N-27/N-39 to 21/28/40, and #296's
// "Carrying & Bringing" reposition (old Unit 43 -> new Unit 15) shifted them
// up by one again to 22/29/41). Most sit between phases/stages, but Phase
        ...
        units: [
          {
            ...
            lessonIds: [
              ...
              'unit-10-present-4',
              'unit-10-present-4-plural',
              'unit-10-present-5',
              'unit-10-present-5-plural',
              'unit-10-present-6',
              'unit-10-present-6-plural',
              'unit-10-present-recognition-1',
              'unit-10-present-recognition-1-plural',
              'unit-10-present-recognition-2',
              'unit-10-present-recognition-2-plural',
          ...
          },
          {
            ...
            lessonIds: [
              ...
              'ukan-past-pool-4',
              'ukan-past-pool-4-plural',
              'ukan-past-pool-5',
              'ukan-past-pool-5-plural',
              'ukan-past-pool-6',
              'ukan-past-pool-6-plural',
              'ukan-past-pool-recognition-1',
              'ukan-past-pool-recognition-1-plural',
              'ukan-past-pool-recognition-2',
              'ukan-past-pool-recognition-2-plural',
        ...
        units: [
          {
            ...
            focus: 'Recombines Units 38–39\'s -arazi with future, conditional, and imperative — zero new verbs, score-gated',
            status: 'pending',
            gate: true,
          },
        ],
...
// 10, 21, 28, 40 — see the `gate: true` note above) — `getUnlockedLessonIds`
