        ...
        units: [
          {
            ...
            focus: 'dezaket/naiteke contrasted with periphrastic ahal izan/ezin (#410/#411) — production for NOR/NOR-NORK, recognition-only for the dative paradigms; plus ukan\'s NOR-NORK object axis (zaitzaket-type forms, #352, extended to every NORK value by #424) across all three Ahalera sub-tenses — present, hypothetical, and past; esan/eman\'s ditransitive Ahalera (diezaioket-type forms, #366) recognition-only',
          ...
          },
          {
            ...
            focus: 'ba- protasis + -ke apodosis — production for NOR/NOR-NORK, recognition-only for the dative paradigms; plus ukan\'s NOR-NORK object axis (bazintut/zintuket-type forms, #353, extended to every NORK value by #424) across Baldintza and Ondorioa present/past; esan/eman\'s ditransitive Baldintza/Ondorioa (balio/nioke-type forms, #366) recognition-only',
