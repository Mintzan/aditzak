...
function computeStars(score, total) {
  if (total === 0) return 0
...
function recordResult(progress, lessonId, result) {
...
function getUnlockedLessonIds(lessons, progress) {
...
function generateQuestions(verb, tense) {
